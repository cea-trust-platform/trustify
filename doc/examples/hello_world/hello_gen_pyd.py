...
class Read_file_bin(Read_file):
    ...
    """
    _synonyms: ClassVar[dict] = {None: ['read_file_binary', 'lire_fichier_bin'], 'name_obj': [], 'filename': []}
...
class Write_file(Interprete):
    ...
    name_obj: str = Field(description=r"""Name of the object to be written.""", default='')
    filename: str = Field(description=r"""Name of the file.""", default='')
    _synonyms: ClassVar[dict] = {None: ['ecrire_fichier', 'ecrire_fichier_bin'], 'name_obj': [], 'filename': []}
...
class Raffiner_isotrope(Interprete):
    ...
    elements: \includetabfig{{raffinerisotri.pdf}}{{4}}{{raffinerisorect.pdf}}{{4}} For 3D
    elements: \includepng{{raffinerisotetra.jpeg}}{{6}}
...
class Remove_elem(Interprete):
    ...
    decribed below : \includepng{{removeelem.png}}{{11.234}}
    """
    domaine: str = Field(description=r"""Name of domain""", default="")
...
class Interpolation_ibm_elem_fluid(Interpolation_ibm_base):
    ...
    _synonyms: ClassVar[dict] = {None: ['ibm_element_fluide', 'interpolation_ibm_element_fluide'], 'points_fluides': [], 'points_solides': [], 'elements_fluides': [], 'correspondance_elements': [], 'impr': [], 'nb_histo_boxes_impr': []}
...
class Interpolation_ibm_mean_gradient(Interpolation_ibm_base):
    ...
    correspondance_elements: Field_base = Field(description=r"""Cell field giving the SALOME cell number""", default_factory=lambda: eval("Field_base()"))
    elements_solides: Field_base = Field(description=r"""Node field giving the element number containing the solid point""", default_factory=lambda: eval("Field_base()"))
    _synonyms: ClassVar[dict] = {None: ['ibm_gradient_moyen', 'interpolation_ibm_gradient_moyen'], 'points_solides': [], 'est_dirichlet': [], 'correspondance_elements': [], 'elements_solides': [], 'impr': [], 'nb_histo_boxes_impr': []}
...
class Partitionneur_partition(Partitionneur_deriv):
    ...
    """
    domaine: str = Field(description=r"""domain name""", default="")
    _synonyms: ClassVar[dict] = {None: ['decouper', 'partition'], 'domaine': [], 'nb_parts': []}
...
class Partition(Interprete):
    ...
    _synonyms: ClassVar[dict] = {None: ['decouper'], 'domaine': [], 'bloc_decouper': []}
...
class Paroi_echange_externe_impose(Condlim_base):
    ...
    temperature.
    """
    h_imp: str = Field(description=r"""Heat exchange coefficient value (expressed in W.m-2.K-1).""", default='')
    himpc: Front_field_base = Field(description=r"""Boundary field type.""", default_factory=lambda: eval("Front_field_base()"))
    text: str = Field(description=r"""External temperature value (expressed in oC or K).""", default='')
    ch: Front_field_base = Field(description=r"""Boundary field type.""", default_factory=lambda: eval("Front_field_base()"))
    _synonyms: ClassVar[dict] = {None: [], 'h_imp': [], 'himpc': [], 'text': [], 'ch': []}
...
class Constituant(Milieu_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'coefficient_diffusion': [], 'gravite': [], 'porosites_champ': [], 'diametre_hyd_champ': [], 'porosites': [], 'rho': [], 'lambda_': ['lambda_u', 'lambda'], 'cp': []}
...
class Stats_serie_posts(Objet_lecture):
    r"""
    Post-processing for statistics. \input{{statistiquesseries}}
    """
...
class Stats_serie_posts_fichier(Objet_lecture):
    r"""
    Serial_statistics read from a file. \input{{statistiquesseries}}
    """
    mot: Literal["dt_integr"] = Field(description=r"""Keyword is used to set the statistics period of integration and write period.""", default="dt_integr")
    dt_integr: float = Field(description=r"""Average on dt_integr time interval is post-processed every dt_integr seconds.""", default=0.0)
    fichier: str = Field(description=r"""name of file""", default='')
...
class Corps_postraitement(Postraitement):
    ...
    not_set
    """
    _synonyms: ClassVar[dict] = {None: ['nul'], 'fichier': [], 'format': [], 'domaine': [], 'sous_domaine': ['sous_zone'], 'parallele': [], 'definition_champs': [], 'definition_champs_fichier': ['definition_champs_file'], 'sondes': ['probes'], 'sondes_fichier': ['probes_file'], 'sondes_mobiles': ['mobile_probes'], 'sondes_mobiles_fichier': ['mobile_probes_file'], 'deprecatedkeepduplicatedprobes': [], 'champs': ['fields'], 'champs_fichier': ['fields_file'], 'statistiques': ['statistics'], 'statistiques_fichier': ['statistics_file'], 'statistiques_en_serie': ['serial_statistics'], 'statistiques_en_serie_fichier': ['serial_statistics_file'], 'suffix_for_reset': []}
...
class Pb_base(Pb_gen_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Stat_post_moyenne(Stat_post_deriv):
    ...
    not_set
    """
    field: str = Field(description=r"""not_set""", default='')
...
class Stat_post_correlation(Stat_post_deriv):
    ...
    not_set
    """
    first_field: str = Field(description=r"""not_set""", default='')
    second_field: str = Field(description=r"""not_set""", default='')
    localisation: Optional[Literal["elem","som","faces"]] = Field(description=r"""Localisation of post-processed field value""", default=None)
    _synonyms: ClassVar[dict] = {None: ['correlation', 'champ_post_statistiques_correlation'], 'first_field': [], 'second_field': [], 'localisation': []}
...
class Lata_to_other(Interprete):
    ...
    """
    format: Optional[Literal["lml","lata","lata_v2","med"]] = Field(description=r"""Results format (MED or LATA or LML keyword).""", default=None)
...
class Ecrire_med(Interprete):
    r"""
    Write a domain to MED format into a file.
    """
    nom_dom: str = Field(description=r"""Name of domain.""", default="")
    file: str = Field(description=r"""Name of file.""", default='')
    _synonyms: ClassVar[dict] = {None: ['write_med'], 'nom_dom': [], 'file': []}
...
class Read_med(Interprete):
    ...
    domains (Raccord) when the name of the boundary begins by type_raccord_. For example, a
    ...
    _synonyms: ClassVar[dict] = {None: ['lire_med'], 'convertalltopoly': [], 'domain': ['domaine'], 'file': ['fichier'], 'mesh': ['maillage'], 'exclude_groups': ['exclure_groupes'], 'include_additional_face_groups': ['inclure_groupes_faces_additionnels']}
...
class Pb_post(Pb_base):
    ...
    not_set
    """
    _synonyms: ClassVar[dict] = {None: ['nul'], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_conduction(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'solide': [], 'conduction': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'fluide_ostwald': [], 'fluide_sodium_liquide': [], 'fluide_sodium_gaz': [], 'navier_stokes_standard': [], 'convection_diffusion_temperature': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Convection_diffusion_concentration(Eqn_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'nom_inconnue': [], 'alias': [], 'masse_molaire': [], 'disable_equation_residual': [], 'convection': [], 'diffusion': [], 'conditions_limites': ['boundary_conditions'], 'conditions_initiales': ['initial_conditions'], 'sources': [], 'ecrire_fichier_xyz_valeur': [], 'parametre_equation': [], 'equation_non_resolue': [], 'renommer_equation': ['rename_equation']}
...
class Pb_hydraulique_concentration(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_concentration': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_cloned_concentration(Pb_base):
    ...
    convection_diffusion_temperature: Optional[Convection_diffusion_temperature] = Field(description=r"""Energy equation (temperature diffusion convection).""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_concentration': [], 'convection_diffusion_temperature': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_avec_liste_conc(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'list_equations': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_list_concentration(Pb_avec_liste_conc):
    ...
    navier_stokes_standard: Optional[Navier_stokes_standard] = Field(description=r"""Navier-Stokes equations.""", default=None)
    convection_diffusion_temperature: Optional[Convection_diffusion_temperature] = Field(description=r"""Energy equation (temperature diffusion convection).""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_temperature': [], 'list_equations': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_list_concentration(Pb_avec_liste_conc):
    ...
    constituant: Optional[Constituant] = Field(description=r"""Constituents.""", default=None)
    navier_stokes_standard: Optional[Navier_stokes_standard] = Field(description=r"""Navier-Stokes equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'list_equations': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_avec_passif(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'equations_scalaires_passifs': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_concentration_scalaires_passifs(Pb_avec_passif):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_concentration': [], 'convection_diffusion_temperature': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_scalaires_passifs(Pb_avec_passif):
    ...
    navier_stokes_standard: Optional[Navier_stokes_standard] = Field(description=r"""Navier-Stokes equations.""", default=None)
    convection_diffusion_temperature: Optional[Convection_diffusion_temperature] = Field(description=r"""Energy equations (temperature diffusion convection).""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_temperature': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_concentration_scalaires_passifs(Pb_avec_passif):
    ...
    navier_stokes_standard: Optional[Navier_stokes_standard] = Field(description=r"""Navier-Stokes equations.""", default=None)
    convection_diffusion_concentration: Optional[Convection_diffusion_concentration] = Field(description=r"""Constituent transport equations (concentration diffusion convection).""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_standard': [], 'convection_diffusion_concentration': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'navier_stokes_standard': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Modele_turbulence_scal_base(Objet_u):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'dt_impr_nusselt': [], 'turbulence_paroi': []}
...
class Pb_thermohydraulique_cloned_concentration_turbulent(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_concentration_turbulent': [], 'convection_diffusion_temperature_turbulent': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_cloned_concentration_turbulent(Pb_base):
    ...
    navier_stokes_turbulent: Optional[Navier_stokes_turbulent] = Field(description=r"""Navier-Stokes equations as well as the associated turbulence model equations.""", default=None)
    convection_diffusion_concentration_turbulent: Optional[Convection_diffusion_concentration_turbulent] = Field(description=r"""Constituent transport equations (concentration diffusion convection) as well as the associated turbulence model equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_concentration_turbulent': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_turbulent(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'navier_stokes_turbulent': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_turbulent(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'navier_stokes_turbulent': [], 'convection_diffusion_temperature_turbulent': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_turbulent_scalaires_passifs(Pb_avec_passif):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_temperature_turbulent': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_concentration_turbulent_scalaires_passifs(Pb_avec_passif):
    ...
    navier_stokes_turbulent: Optional[Navier_stokes_turbulent] = Field(description=r"""Navier-Stokes equations as well as the associated turbulence model equations.""", default=None)
    convection_diffusion_concentration_turbulent: Optional[Convection_diffusion_concentration_turbulent] = Field(description=r"""Constituent transport equations (concentration diffusion convection) as well as the associated turbulence model equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_concentration_turbulent': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_concentration_turbulent_scalaires_passifs(Pb_avec_passif):
    ...
    convection_diffusion_concentration_turbulent: Optional[Convection_diffusion_concentration_turbulent] = Field(description=r"""Constituent transport equations (concentration diffusion convection) as well as the associated turbulence model equations.""", default=None)
    convection_diffusion_temperature_turbulent: Optional[Convection_diffusion_temperature_turbulent] = Field(description=r"""Energy equations (temperature diffusion convection) as well as the associated turbulence model equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_concentration_turbulent': [], 'convection_diffusion_temperature_turbulent': [], 'equations_scalaires_passifs': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_list_concentration_turbulent(Pb_avec_liste_conc):
    ...
    navier_stokes_turbulent: Optional[Navier_stokes_turbulent] = Field(description=r"""Navier-Stokes equations as well as the associated turbulence model equations.""", default=None)
    convection_diffusion_temperature_turbulent: Optional[Convection_diffusion_temperature_turbulent] = Field(description=r"""Energy equation (temperature diffusion convection) as well as the associated turbulence model equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'convection_diffusion_temperature_turbulent': [], 'list_equations': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_list_concentration_turbulent(Pb_avec_liste_conc):
    ...
    constituant: Optional[Constituant] = Field(description=r"""Constituents.""", default=None)
    navier_stokes_turbulent: Optional[Navier_stokes_turbulent] = Field(description=r"""Navier-Stokes equations as well as the associated turbulence model equations.""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'fluide_incompressible': [], 'constituant': [], 'navier_stokes_turbulent': [], 'list_equations': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_turbulent_qc(Pb_base):
    ...
    navier_stokes_turbulent_qc: Navier_stokes_turbulent_qc = Field(description=r"""Navier-Stokes equations under low Mach number as well as the associated turbulence model equations.""", default_factory=lambda: eval("Navier_stokes_turbulent_qc()"))
    convection_diffusion_chaleur_turbulent_qc: Convection_diffusion_chaleur_turbulent_qc = Field(description=r"""Energy equation under low Mach number as well as the associated turbulence model equations.""", default_factory=lambda: eval("Convection_diffusion_chaleur_turbulent_qc()"))
    _synonyms: ClassVar[dict] = {None: [], 'fluide_quasi_compressible': [], 'navier_stokes_turbulent_qc': [], 'convection_diffusion_chaleur_turbulent_qc': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_melange_binaire_turbulent_qc(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_quasi_compressible': [], 'navier_stokes_turbulent_qc': [], 'convection_diffusion_espece_binaire_turbulent_qc': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Schmidt(Modele_turbulence_scal_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'scturb': [], 'dt_impr_nusselt': [], 'turbulence_paroi': []}
...
class Modele_turbulence_scal_null(Modele_turbulence_scal_base):
    ...
    _synonyms: ClassVar[dict] = {None: ['null'], 'dt_impr_nusselt': []}
...
class Prandtl(Modele_turbulence_scal_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'prdt': [], 'prandt_turbulent_fonction_nu_t_alpha': [], 'dt_impr_nusselt': [], 'turbulence_paroi': []}
...
class Sets(Simpler):
    ...
    iter_min: Optional[int] = Field(description=r"""Number of minimum iterations""", default=None)
    seuil_convergence_implicite: Optional[float] = Field(description=r"""Convergence criteria.""", default=None)
    nb_corrections_max: Optional[int] = Field(description=r"""Maximum number of corrections performed by the PISO algorithm to achieve the projection of the velocity field. The algorithm may perform less corrections then nb_corrections_max if the accuracy of the projection is sufficient. (By default nb_corrections_max is set to 21).""", default=None)
    ...
    _synonyms: ClassVar[dict] = {None: [], 'criteres_convergence': [], 'iter_min': [], 'seuil_convergence_implicite': [], 'nb_corrections_max': [], 'facsec_diffusion_for_sets': [], 'seuil_convergence_solveur': [], 'seuil_generation_solveur': [], 'seuil_verification_solveur': [], 'seuil_test_preliminaire_solveur': [], 'solveur': [], 'no_qdm': [], 'nb_it_max': [], 'controle_residu': []}
...
class Pb_multiphase(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'milieu_composite': [], 'milieu_musig': [], 'qdm_multiphase': [], 'masse_multiphase': [], 'energie_multiphase': [], 'echelle_temporelle_turbulente': [], 'energie_cinetique_turbulente': [], 'energie_cinetique_turbulente_wit': [], 'taux_dissipation_turbulent': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_multiphase_hem(Pb_multiphase):
    ...
    equations
    """
    _synonyms: ClassVar[dict] = {None: ['pb_hem'], 'milieu_composite': [], 'milieu_musig': [], 'qdm_multiphase': [], 'masse_multiphase': [], 'energie_multiphase': [], 'echelle_temporelle_turbulente': [], 'energie_cinetique_turbulente': [], 'energie_cinetique_turbulente_wit': [], 'taux_dissipation_turbulent': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_multiphase_enthalpie(Pb_multiphase):
    ...
    _synonyms: ClassVar[dict] = {None: ['pb_multiphase_h'], 'milieu_composite': [], 'correlations': [], 'qdm_multiphase': [], 'masse_multiphase': [], 'energie_multiphase_h': ['energie_multiphase_enthalpie'], 'milieu_musig': [], 'echelle_temporelle_turbulente': [], 'energie_cinetique_turbulente': [], 'energie_cinetique_turbulente_wit': [], 'taux_dissipation_turbulent': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'resume_last_time': []}
...
class Pb_hydraulique_melange_binaire_qc(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_quasi_compressible': [], 'constituant': [], 'navier_stokes_qc': [], 'convection_diffusion_espece_binaire_qc': [], 'milieu': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_qc(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_quasi_compressible': [], 'navier_stokes_qc': [], 'convection_diffusion_chaleur_qc': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Mass_source(Objet_u):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'bord': [], 'surfacic_flux': []}
...
class Pb_thermohydraulique_especes_qc(Pb_avec_passif):
    ...
    navier_stokes_qc: Navier_stokes_qc = Field(description=r"""Navier-Stokes equation for a quasi-compressible fluid.""", default_factory=lambda: eval("Navier_stokes_qc()"))
    convection_diffusion_chaleur_qc: Convection_diffusion_chaleur_qc = Field(description=r"""Temperature equation for a quasi-compressible fluid.""", default_factory=lambda: eval("Convection_diffusion_chaleur_qc()"))
    _synonyms: ClassVar[dict] = {None: [], 'fluide_quasi_compressible': [], 'navier_stokes_qc': [], 'convection_diffusion_chaleur_qc': [], 'equations_scalaires_passifs': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_especes_wc(Pb_avec_passif):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_weakly_compressible': [], 'navier_stokes_wc': [], 'convection_diffusion_chaleur_wc': [], 'equations_scalaires_passifs': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_thermohydraulique_wc(Pb_base):
    ...
    navier_stokes_wc: Navier_stokes_wc = Field(description=r"""Navier-Stokes equation for a weakly-compressible fluid.""", default_factory=lambda: eval("Navier_stokes_wc()"))
    convection_diffusion_chaleur_wc: Convection_diffusion_chaleur_wc = Field(description=r"""Temperature equation for a weakly-compressible fluid.""", default_factory=lambda: eval("Convection_diffusion_chaleur_wc()"))
    _synonyms: ClassVar[dict] = {None: [], 'fluide_weakly_compressible': [], 'navier_stokes_wc': [], 'convection_diffusion_chaleur_wc': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Pb_hydraulique_melange_binaire_wc(Pb_base):
    ...
    _synonyms: ClassVar[dict] = {None: [], 'fluide_weakly_compressible': [], 'navier_stokes_wc': [], 'convection_diffusion_espece_binaire_wc': [], 'milieu': [], 'constituant': [], 'postraitement': ['post_processing'], 'postraitements': ['post_processings'], 'liste_de_postraitements': [], 'liste_postraitements': [], 'sauvegarde': [], 'sauvegarde_simple': [], 'reprise': [], 'correlations': [], 'resume_last_time': []}
...
class Option_polymac(Interprete):
    ...
    """
    use_osqp: Optional[bool] = Field(description=r"""Flag to use the old formulation of the M2 matrix provided by the OSQP library""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'use_osqp': []}

################################################################

class Option_polymac_p0(Interprete):
    r"""
    Class of PolyMAC_P0 options.
    """
    interp_ve1: Optional[bool] = Field(description=r"""Flag to enable a first order velocity face-to-element interpolation (the default value is 0 which means a second order interpolation)""", default=None)
    traitement_axi: Optional[bool] = Field(description=r"""Flag used to relax the time-step stability criterion in case of a thin slice geometry while modelling an axi-symetrical case""", default=None)
    _synonyms: ClassVar[dict] = {None: [], 'interp_ve1': [], 'traitement_axi': []}
